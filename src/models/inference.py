...
def get_model_logits_imagenet(model_name, data_path, batch_size=128, num_workers=4, split="test"):
    """
    Extracts or loads cached logits for a specific model on ImageNet.
    """
